...
En Tango Restó para **Delta o T20**, la versión mínima mínima requerida para habiltar esta funcionalidad es la **20.01.000.3810 o superior**.
...
La última versión del hotfix para **T19** es: **19.01.000.4980** con **Versión del instalador**: 19.1.0.151 (INSTALLERRESTOAPISERVICE.EXE)
  
La última versión para **Delta o T20** es: **20.01.000.3584** con **Versión del instalador**: 20.1.0.645 (INSTALLERRESTOAPISERVICE.EXE)
